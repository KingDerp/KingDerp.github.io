...
var $author$project$Main$init = function (_v0) {
	...
	var max_age = 100;
	var default_target_gross_income = 50000;
	var default_age = 65;
...
var $author$project$Main$bucketValues = F6(
	function (growth_percentage, incomes_from_assets, total_years, payout_years, social_sec, other_income) {
		var years = A2($elm$core$List$range, 1, total_years);
		var starting_previous_bucket_value = 0.0;
		var bucketValueGP = $author$project$Main$bucketValue(growth_percentage);
		var calcBucketValue = F2(
			function (year, acc) {
				var social_sec_income = A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($elm$core$Array$get, year - 1, social_sec));
				var other_monthly_income = A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($elm$core$Array$get, year - 1, other_income));
				var total_other_monthly_income = other_monthly_income + social_sec_income;
				var is_payout_year = _Utils_cmp(total_years - year, payout_years) < 1;
				var income_from_assets = A2(
					$elm$core$Maybe$withDefault,
					0.0,
					A2($elm$core$Array$get, year - 1, incomes_from_assets));
				var asset_payout_required = income_from_assets - total_other_monthly_income;
				var array_idx = total_years - year;
				var previous_bucket_value = A2(
					$elm$core$Maybe$withDefault,
					starting_previous_bucket_value,
					A2($elm$core$Array$get, array_idx - 1, acc));
				var calculated_bucket_val = A4(bucketValueGP, asset_payout_required, previous_bucket_value, is_payout_year, array_idx);
				return _Utils_eq(year, total_years) ? acc : A3($elm$core$Array$set, array_idx, calculated_bucket_val, acc);
			});
...
var $author$project$Main$bucket1 = F3(
	function (income_from_assets, social_security_income, other_income) {
		return A6($author$project$Main$bucketValues, 0.01, income_from_assets, 4, 4, social_security_income, other_income);
	});
var $author$project$Main$bucket2 = F3(
	function (income_from_assets, social_security_income, other_income) {
		return A6($author$project$Main$bucketValues, 0.025, income_from_assets, 6, 2, social_security_income, other_income);
	});
var $author$project$Main$bucket3 = F3(
	function (income_from_assets, social_security_income, other_income) {
		return A6($author$project$Main$bucketValues, 0.03, income_from_assets, 8, 2, social_security_income, other_income);
	});
var $author$project$Main$bucket4 = F3(
	function (income_from_assets, social_security_income, other_income) {
		return A6($author$project$Main$bucketValues, 0.035, income_from_assets, 11, 3, social_security_income, other_income);
	});
var $author$project$Main$bucket5 = F3(
	function (income_from_assets, social_security_income, other_income) {
		return A6($author$project$Main$bucketValues, 0.04, income_from_assets, 21, 10, social_security_income, other_income);
	});
...
var $author$project$Main$allBuckets = F4(
	function (m, income_from_assets, social_security_income, other_income) {
		var outer_array = $elm$core$Array$empty;
		return A2(
			$elm$core$Array$push,
			A4($author$project$Main$bucket6, m, income_from_assets, social_security_income, other_income),
			A2(
				$elm$core$Array$push,
				A3($author$project$Main$bucket5, income_from_assets, social_security_income, other_income),
				A2(
					$elm$core$Array$push,
					A3($author$project$Main$bucket4, income_from_assets, social_security_income, other_income),
					A2(
						$elm$core$Array$push,
						A3($author$project$Main$bucket3, income_from_assets, social_security_income, other_income),
						A2(
							$elm$core$Array$push,
							A3($author$project$Main$bucket2, income_from_assets, social_security_income, other_income),
							A2(
								$elm$core$Array$push,
...
var $author$project$Main$getBucketValsByRow = F2(
	function (i, a) {
		return A2(
			...
			F2(
				function (j, x) {
					return A2($author$project$Main$getBucketValByRow, i, x);
				}),
			a);
	});
	...
	function (i, duration_of_agreement, current_month, starting_age, model, arr) {
		...
		while (true) {
			...
			if (_Utils_eq(i, duration_of_agreement - 1)) {
				...
				if (i === 1) {
					var _new = A3($elm$core$Array$set, i - 1, _default, arr);
					var $temp$i = i + 1,
						$temp$duration_of_agreement = duration_of_agreement,
						$temp$current_month = current_month,
						$temp$starting_age = starting_age,
						$temp$model = model,
						$temp$arr = A3($elm$core$Array$set, i, _default * (1 + calculated_cola), _new);
					i = $temp$i;
					duration_of_agreement = $temp$duration_of_agreement;
					current_month = $temp$current_month;
					starting_age = $temp$starting_age;
					model = $temp$model;
					arr = $temp$arr;
					continue incomeFromAssetsInit;
				} else {
					var $temp$i = i + 1,
						$temp$duration_of_agreement = duration_of_agreement,
						$temp$current_month = current_month,
						$temp$starting_age = starting_age,
						$temp$model = model,
						$temp$arr = A3($elm$core$Array$set, i, _default * (1 + calculated_cola), arr);
					i = $temp$i;
					duration_of_agreement = $temp$duration_of_agreement;
					current_month = $temp$current_month;
					starting_age = $temp$starting_age;
...
var $author$project$Main$incomeFromAssetsUsingYearCOLAStartingIncome = F5(
	function (duration_of_agreement, target_gross_income, current_month, starting_age, model) {
	...
	function (i, amt, growth_rate) {
		...
		while (true) {
			if ((!i) || (i < 0)) {
				...
				var $temp$i = i - 1,
					$temp$amt = amt * (1 + growth_rate),
					$temp$growth_rate = growth_rate;
				i = $temp$i;
				amt = $temp$amt;
				growth_rate = $temp$growth_rate;
				continue calculateIncomeViaGrowthRate;
			}
		}
	});
...
var $author$project$Main$otherMonthlyIncomesInit = F3(
	function (duration, other_incomes, income_from_assets) {
		var other_incomes_val_only = $elm$core$Array$fromList(
			$elm$core$Dict$values(other_incomes));
		var arr_income = A2(
			$elm$core$Array$map,
			function (_v2) {
				return A2(
			...
			other_incomes_val_only);
		var initialized_income_arrs = A2(
			$elm$core$Array$indexedMap,
			F2(
				function (i, dv) {
					return A2(
						...
						F2(
							function (j, _v1) {
								return A2($author$project$Main$incomePayout, j, dv);
							}),
						A2(
							$elm$core$Maybe$withDefault,
							$elm$core$Array$empty,
							A2($elm$core$Array$get, i, arr_income)));
				}),
			other_incomes_val_only);
		return (duration <= 0) ? $elm$core$Array$empty : A2(
			$elm$core$Array$indexedMap,
			F2(
				function (i, _v0) {
...
var $author$project$Main$threeBucketPlan = F4(
	function (m, income_from_assets, social_security_income, other_income) {
		...
		return A2(
			$elm$core$Array$push,
			A4($author$project$Main$riskBucket, m, income_from_assets, social_security_income, other_income),
			A2(
				$elm$core$Array$push,
				A3($author$project$Main$bucketThreeForThreePlan, income_from_assets, social_security_income, other_income),
				A2(
					$elm$core$Array$push,
					A3($author$project$Main$bucketTwoForThreePlan, income_from_assets, social_security_income, other_income),
					A2(
						$elm$core$Array$push,
...
var $author$project$Main$formatFloatAsDollar = function (f) {
...
var $author$project$Main$formatIntAsDollarShowZero = function (i) {
...
var $author$project$Main$viewError = function (e) {
	return _Utils_eq(e.error_status, $author$project$Main$None) ? A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('text-red-900 text-center')
			]),
		_List_fromArray(
			[
...
var $author$project$Main$viewPossibeEndYear = function (m) {
...
var $author$project$Main$viewOtherIncome = function (m) {
	return $elm$core$Dict$isEmpty(m.other_monthly_incomes) ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$viewSocialSecurityInputs = F3(
	function (c, update_social_age, update_social_monthly) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('flex flex-col items-center justify-center w-full my-4')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Social Security')
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('flex flex-row items-center justify-start w-full')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('text-base text-white w-1/2 text-right whitespace-no-wrap')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onInput(update_social_age),
					...
					$author$project$Main$viewError(c.error)
				]));
	});
var $author$project$Main$viewSeedFields = function (m) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex flex-col items-center justify-center m-2 w-full')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-xl text-white text-center uppercase font-bold mb-2')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('border p-3 rounded-lg flex items-center flex-col w-full bg-gray-600')
							]),
						_List_fromArray(
							[
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('text-base text-white w-1/4 text-right')
													]),
												_List_fromArray(
													[
								...
								A3($author$project$Main$viewSocialSecurityInputs, m.client_1, $author$project$Main$UpdateSocialSecAgeClient1, $author$project$Main$UpdateSocialSecurityMontlhlyIncomeClient1)
							]))
					])),
					...
					[
						...
						_List_fromArray(
							[
								...
								A3($author$project$Main$viewSocialSecurityInputs, m.client_2, $author$project$Main$UpdateSocialSecAgeClient2, $author$project$Main$UpdateSocialSecurityMontlhlyIncomeClient2),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$ToggleClient2),
										$elm$html$Html$Attributes$class('m-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Remove Second Person')
									]))
							]))
					])) : A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('flex flex-col items-center justify-center m-2 w-1/4')
							]),
						_List_fromArray(
							[
								A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('w-full h-full border-b-8 border-r-8 text-center'),
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('w-full h-full border-r-8 border-t-8 text-center'),
														A2($elm$html$Html$Attributes$style, 'max-width', '50px'),
														A2($elm$html$Html$Attributes$style, 'max-height', '50px'),
														A2($elm$html$Html$Attributes$style, 'min-width', '50px'),
														A2($elm$html$Html$Attributes$style, 'min-height', '50px')
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('w-full h-full border-b-8 border-l-8 text-center'),
														A2($elm$html$Html$Attributes$style, 'max-width', '50px'),
														A2($elm$html$Html$Attributes$style, 'max-height', '50px'),
														A2($elm$html$Html$Attributes$style, 'min-width', '50px'),
														A2($elm$html$Html$Attributes$style, 'min-height', '50px')
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('w-full h-full border-l-8 border-t-8 text-center'),
														A2($elm$html$Html$Attributes$style, 'max-width', '50px'),
														A2($elm$html$Html$Attributes$style, 'max-height', '50px'),
														A2($elm$html$Html$Attributes$style, 'min-width', '50px'),
														A2($elm$html$Html$Attributes$style, 'min-height', '50px')
	...
	function (a, i) {
		...
		if (_v0.$ === 'Nothing') {
			...
			if (val.$ === 'Nothing') {
				...
				var v = val.a;
				return $elm$core$Basics$round(v);
			}
		}
	});
...
var $author$project$Main$addCSSClasses = F2(
	function (s_1, s_2) {
		return $elm$core$String$trim(s_1) + (' ' + $elm$core$String$trim(s_2));
	});
var $author$project$Main$formatAgeAsString = function (year) {
	return (!year) ? '' : $elm$core$String$fromInt(year);
};
var $author$project$Main$formatIntAsDollar = function (i) {
	var s = (!i) ? '' : $elm$core$String$fromInt(i);
	var string_with_commas = A2($author$project$Main$addCommas, s, _List_Nil);
	return (s === '') ? '' : ('$' + string_with_commas);
};
var $author$project$Main$formatTotalIncomeFromAssets = function (i) {
	return (i < 0) ? $author$project$Main$formatIntAsDollarShowZero(0) : $author$project$Main$formatIntAsDollar(i);
};
var $author$project$Main$formatYearAsString = F2(
	function (current_year, comparison_year) {
...
var $author$project$Main$formatBucketVal = F2(
	function (c, p) {
...
var $author$project$Main$viewTableCell = F2(
	function (cell_text, cell_classes) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(cell_classes)
				]),
			_List_fromArray(
				[
...
var $author$project$Main$viewStandardHidableCell = F2(
	function (cell_text, b) {
		var cell_classes = $author$project$Main$addHiddenToStandardCellClasses(b);
		return A2($author$project$Main$viewTableCell, cell_text, cell_classes);
	});
var $author$project$Main$viewRowWithFiveBuckets = F2(
	function (m, tr) {
...
var $author$project$Main$createTableDataFrom = F3(
	function (m, buckets, income_from_assets) {
		return $elm$core$Array$isEmpty(income_from_assets) ? _List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Duration is zero or less')
					]))
			]) : $elm$core$Array$toList(
			A2(
				$elm$core$Array$indexedMap,
				F2(
					function (i, x) {
						...
						var bucket_4_val = A2($author$project$Main$getIncomeValOrZero, bucket_row, 3);
						var bucket_3_val = A2($author$project$Main$getIncomeValOrZero, bucket_row, 2);
...
var $author$project$Main$viewFiveBucketHeaderRow = function (m) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class($author$project$Main$headerTableRowClasses)
			]),
		_List_fromArray(
			[
				$author$project$Main$viewStandardHeaderCell('Age'),
				$author$project$Main$viewStandardHeaderCell('Date'),
				$author$project$Main$viewStandardHeaderCell('Net Monthly Income'),
				$author$project$Main$viewStandardHeaderCell('Net Annual Income'),
				$author$project$Main$viewStandardHeaderCell('Taxes'),
				$author$project$Main$viewStandardHeaderCell('Gross Income'),
				A2($author$project$Main$viewStandardHidableHeaderCell, 'Other Income', hide_other_income),
				A2($author$project$Main$viewStandardHidableHeaderCell, 'Social Security', hide_social_security),
				$author$project$Main$viewStandardHeaderCell('Total Income From Assets'),
				$author$project$Main$viewStandardHeaderCell('Bucket 1'),
				$author$project$Main$viewStandardHeaderCell('Bucket 2'),
				$author$project$Main$viewStandardHeaderCell('Bucket 3'),
				$author$project$Main$viewStandardHeaderCell('Bucket 4'),
				$author$project$Main$viewStandardHeaderCell('Bucket 5'),
				$author$project$Main$viewStandardHeaderCell('Risk Bucket'),
				$author$project$Main$viewStandardHeaderCell('Total Projected Asset Balance')
			]));
};
var $author$project$Main$viewThreeBucketHeaderRow = function (m) {
	var hide_social_security = $author$project$Main$hideSocialSecurity(m);
	var hide_other_income = $author$project$Main$isOtherMonthlyIncomeHidden(m);
	return A2(
		$elm$html$Html$div,
...
var $author$project$Main$viewPercentageHeaderWithThreeBuckets = function (m) {
	var hide_social_security = $author$project$Main$hideSocialSecurity(m);
	var hide_other_income = $author$project$Main$isOtherMonthlyIncomeHidden(m);
	return A2(
		$elm$html$Html$div,
...
var $author$project$Main$viewTableHeaders = function (m) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewPercentageHeader(m),
				$author$project$Main$viewBucketHeader(m)
			]));
};
...
var $author$project$Main$viewTargetGrossIncome = function (m) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Calculate":[],"InsertNewIncome":[],"DeleteIncome":["String.String"],"UpdateStartingIncome":["String.String"],"UpdateSocialSecAgeClient1":["String.String"],"UpdateSocialSecAgeClient2":["String.String"],"UpdateSocialSecurityMontlhlyIncomeClient1":["String.String"],"UpdateSocialSecurityMontlhlyIncomeClient2":["String.String"],"UpdateOtherIncomeName":["String.String","String.String"],"UpdateOtherMonthlyIncome":["String.String","String.String"],"UpdateStartYear":["String.String","String.String"],"UpdateEndYear":["String.String","String.String"],"UpdateAnnualGrowthPercentage":["String.String","String.String"],"UpdateSocialSecurityStartMonthClient1":["String.String"],"UpdateSocialSecurityStartMonthClient2":["String.String"],"UpdateBirthYearClient1":["String.String"],"UpdateBirthYearClient2":["String.String"],"Now":["Time.Posix"],"ToggleClient2":[],"TogglePlanType":["String.String"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));